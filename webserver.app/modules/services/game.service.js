 ...
 * - return the rooms
 */
async function getGameServerRooms(availableRoomList) {
    /**Check if room exists in the Socket object */
    let roomsInSocket = await axios.get(`http://gameserver1:3001/gameserver-online-api/game/rooms`);
    if (roomsInSocket.hasOwnProperty('data')) {
        roomsInSocket = roomsInSocket.data;
    }
